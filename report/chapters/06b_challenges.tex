...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{class_mapping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{mixed_dataset_results.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{augmented_training.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{augmented_confusion.png}
